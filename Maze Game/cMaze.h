...
const int MAXIMUM_WIDTH = 25;
const int MAXIMUM_HEIGHT = 25;
const int DEFAULT_MAZE_WIDTH = 24;
const int DEFAULT_MAZE_HEIGHT = 24;
...
public:  //  cMaze public interface methods
	...
	void    print(int startRow = 0, int startCol = 0);
...
//---------------------------------ADDED CODE------------------------------------------------
	...
	void RemoveObject(cVector2 pos);

	cVector2 GetStartPos();
	cVector2 GetExitPos();
	cVector2 GetRandomExitPos();
	cVector2 GetRandomPos();


	Cell& GetCell(cVector2 pos);

	Cell& CheckUp(cVector2 pos);
	Cell& CheckDown(cVector2 pos);
	Cell& CheckRight(cVector2 pos);
	Cell& CheckLeft(cVector2 pos);
